		...
		public function  load_view($current_nav, $more = array(), $structure = array())
		{
			...
			*/ 
			...
			$data = array(
				...
				'form_open' => form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module='.$this->module_name, array(), array('method' => 'quick_save', 'return' => $this->EE->input->get('method', 'index'))),
