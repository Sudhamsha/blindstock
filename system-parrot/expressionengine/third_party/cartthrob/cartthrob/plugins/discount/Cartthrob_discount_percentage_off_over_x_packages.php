...
class Cartthrob_discount_percentage_off_over_x_packages extends Cartthrob_discount
{
	...
	public function get_discount()
	{
		...
		if ($subtotal >= $this->core->sanitize_number($this->plugin_settings('order_over')))
		{
