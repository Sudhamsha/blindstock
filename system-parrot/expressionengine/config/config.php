...
$config['license_contact'] = 'info@codelab.ie';
$config['license_number'] = '4961-0147-7175-6448';
$config['debug'] = '1';
$config['cp_url'] = 'http://align-it.dev/control.php';
...
$config = $Custom_config->get_environment_config($config);