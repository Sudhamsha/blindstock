...
class Messaging {
    ...
    function send_bulletin()
    {
        ...
        $expires = (version_compare(APP_VER, '2.6.0', '<'))?$this->EE->localize->convert_human_date_to_gmt($_POST['bulletin_expires']):$this->EE->localize->string_to_timestamp($_POST['bulletin_expires']);
