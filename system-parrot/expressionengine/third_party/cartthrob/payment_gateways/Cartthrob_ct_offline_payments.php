<?php 
class Cartthrob_ct_offline_payments extends Cartthrob_payment_gateway
{
		...
		switch ($this->plugin_settings('processing_status'))
		{
			case "complete": 
				$resp =array(
					...
					'failed'			=> FALSE,
					'declined'			=> FALSE,
					'transaction_id'	=> $this->lang('ct_offline_transaction_id'),
					'processing'		=> FALSE,
				); 
				break;
			case "declined": 
				$resp =array(
					'authorized'		=> TRUE,
					'error_message'		=> $this->lang('ct_offline_error_message'),
					'failed'			=> FALSE,
					'declined'			=> FALSE,
					'transaction_id'	=> NULL,
					'processing'		=> FALSE,
			...
			default: 
				$resp =array(
					'authorized'		=> FALSE,
					'error_message'		=> $this->lang('ct_offline_processing_message'),
					'failed'			=> FALSE,
					'processing'		=> TRUE,
					'declined'			=> FALSE,
					'transaction_id'	=> $this->lang('ct_offline_transaction_id')
